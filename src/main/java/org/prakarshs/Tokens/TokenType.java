...
public enum TokenType {
    ...
    Comment("\\#.*"),
    Whitespace("[\\s\\t\\n\\r]"),
    Keyword("(agar|yafir|ya|khatam|dekhiye_baapuji|lijiye_baapuji|dhancha|yeh_lo|kaam|wapas|ghumaghum|andar|by|todiye|agla|assert|raise|ishtart|rescue|ensure)(?=\\s|$)(?!_)"),
    GroupDivider("(\\[|\\]|\\,|\\{|}|\\.{2}|(\\:(?!\\:)))"),
